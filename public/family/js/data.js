  ...
  { key: "XXXX-000",                                    name: {                                                                 }, gender: "",  birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: null,                               hasDNATest: false, height: 0, width: 0 },
    { key: "GQX8-CQP",               child: "XXXX-000", name: { first: "Arbyn",      middle: "Acosta",      last: "Argabioso"   }, gender: "M", birthDate: "1995-04-19", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Santa Cruz, Manila, PH",           hasDNATest: true,  },
      { key: "GQJK-L51",             child: "GQX8-CQP", name: { first: "Rolando",    middle: "Saplala",     last: "Argabioso"   }, gender: "M", birthDate: "1965-10-09", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Poblacion, Caloocan, PH",          hasDNATest: true,  },
        { key: "GQJK-LCT",           child: "GQJK-L51", name: { first: "Marcial",    middle: "Mia",         last: "Argabioso"   }, gender: "M", birthDate: "1932-10-14", deathDate: "2020-02-27", living: false, hasImage: true,   birthPlace: "Majayjay, Laguna, PH",             hasDNATest: false, },
          { key: "GHBZ-TM4",         child: "GQJK-LCT", name: { first: "Eusebio",    middle: "Lopecillo",   last: "Argabioso"   }, gender: "M", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: "Majayjay, Laguna, PH",             hasDNATest: false, },
        ...
        { key: "GHBZ-YVX",           child: "GQJK-L51", name: { first: "Lydia",      middle: "Perez",       last: "Saplala"     }, gender: "F", birthDate: "1944-11-24", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Lubao, Pampanga, PH",              hasDNATest: true,  },
      ...
      { key: "GQJK-G8W",             child: "GQX8-CQP", name: { first: "Corazon",    middle: "Maramba",     last: "Acosta"      }, gender: "F", birthDate: "1971-03-10", deathDate: "2018-05-25", living: false, hasImage: true,   birthPlace: "Sampaloc, Manila, PH",             hasDNATest: false, },
        { key: "GHBD-7M4",           child: "GQJK-G8W", name: { first: "Manuel",     middle: "San Agustin", last: "Acosta Jr."  }, gender: "M", birthDate: "1948-07-06", deathDate: "1979-06-07", living: false, hasImage: true,   birthPlace: "Manila, PH",                       hasDNATest: false, },
          { key: "GHBD-9L6",         child: "GHBD-7M4", name: { first: "Manuel",     middle: "Bongco",      last: "Acosta Sr."  }, gender: "M", birthDate: "1913-11-10", deathDate: "1994-11-20", living: false, hasImage: true,   birthPlace: "Orani, Bataan, PH",                hasDNATest: false, },
            ...
            { key: "GHB8-5K8",       child: "GHBD-9L6", name: { first: "Maximiana",  middle: "Cahanding",   last: "Bongco"      }, gender: "F", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: "Orani, Bataan, PH",                hasDNATest: false, },
              { key: "G4MF-WD8",     child: "GHB8-5K8", name: { first: "Fabian",     middle: "",            last: "Bongco"      }, gender: "M", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: "Orani, Bataan, PH",                hasDNATest: false, },
              { key: "GHB8-5K8",     child: "GHB8-5K8", name: { first: "Lucina",     middle: "",            last: "Cahanding"   }, gender: "F", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: "Orani, Bataan, PH",                hasDNATest: false, },
          { key: "GHB8-DXY",         child: "GHBD-7M4", name: { first: "Natividad",  middle: "Villacorta",  last: "San Agustin" }, gender: "F", birthDate: "1925-12-21", deathDate: "2008-10-09", living: false, hasImage: true,   birthPlace: "Ermita, Manila, PH",               hasDNATest: false, },
        ...
        { key: "GHB8-J1B",           child: "GQJK-G8W", name: { first: "Catalina",   middle: "Dumantay",    last: "Maramba"     }, gender: "F", birthDate: "1943-01-28", deathDate: "1974-08-10", living: false, hasImage: true,   birthPlace: "Santa Barbara, Pangasinan, PH",    hasDNATest: false, },
          { key: "GHB8-GB6",         child: "GHB8-J1B", name: { first: "Sotero",     middle: "Reyes",       last: "Maramba Sr." }, gender: "M", birthDate: "1910-04-22", deathDate: "1969-12-12", living: false, hasImage: true,   birthPlace: "Santa Barbara, Pangasinan, PH",    hasDNATest: false, },
            { key: "LLQS-641",       child: "GHB8-GB6", name: { first: "Miguel",     middle: "Bautista",    last: "Maramba"     }, gender: "M", birthDate: "1858",       deathDate: null,         living: false, hasImage: false,  birthPlace: "Santa Barbara, Pangasinan, PH",    hasDNATest: false, },
              ...
              { key: "L281-614",     child: "LLQS-641", name: { first: "Maria",      middle: "Garcia",      last: "Bautista"    }, gender: "F", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: null,                               hasDNATest: false, },
                { key: "GC7T-H59",   child: "L281-614", name: { first: "Agustin",    middle: "",            last: "Bautista"    }, gender: "M", birthDate: "1812-05-29", deathDate: null,         living: false, hasImage: false,  birthPlace: null,                               hasDNATest: false, },
    ...
    { key: "GHB5-TWN",               child: "XXXX-000", name: { first: "Mitchie",    middle: "Ajesta",      last: "Adanza"      }, gender: "F", birthDate: "1994-12-16", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Santa Cruz, Manila, PH",           hasDNATest: true,  },
      { key: "GHB5-XTZ",             child: "GHB5-TWN", name: { first: "Darne",      middle: "Elican",      last: "Adanza"      }, gender: "M", birthDate: "1964-06-22", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Balingasag, Misamis Oriental, PH", hasDNATest: false, },
        { key: "GH12-SVQ",           child: "GHB5-XTZ", name: { first: "Nestor",     middle: "Ladera",      last: "Adanza"      }, gender: "M", birthDate: "1938-02-26", deathDate: "2018-09-29", living: false, hasImage: true,   birthPlace: "Balingasag, Misamis Oriental, PH", hasDNATest: false, },
          { key: "GH12-DRN",         child: "GH12-SVQ", name: { first: "Felomino",   middle: "",            last: "Adanza"      }, gender: "M", birthDate: "about 1901", deathDate: "1990-11-03", living: false, hasImage: false,  birthPlace: "Dumaguete, Negros Oriental, PH",   hasDNATest: false, },
        ...
        { key: "GH12-9F6",           child: "GHB5-XTZ", name: { first: "Rufa",       middle: "Acerto",      last: "Elican"      }, gender: "F", birthDate: "1939-11-28", deathDate: "2015-04-02", living: false, hasImage: true,   birthPlace: "Balingasag, Misamis Oriental, PH", hasDNATest: false, },
      ...
      { key: "GHBR-FK3",             child: "GHB5-TWN", name: { first: "Mylen",      middle: "Vergara",     last: "Ajesta"      }, gender: "F", birthDate: "1974-04-13", deathDate: null,         living: true,  hasImage: true,   birthPlace: "Sinamongan, Pilar, Capiz, PH",     hasDNATest: false, },
        { key: "GH12-Z3C",           child: "GHBR-FK3", name: { first: "Napoleon",   middle: "Crispolon",   last: "Ajesta"      }, gender: "M", birthDate: null,         deathDate: null,         living: false, hasImage: false,  birthPlace: "Binaobawan, Pilar, Capiz, PH",     hasDNATest: false, },
        ...
        { key: "GH12-W17",           child: "GHBR-FK3", name: { first: "Celma",      middle: "Borja",       last: "Vergara"     }, gender: "F", birthDate: "1941-07-08", deathDate: "2020-02-16", living: false, hasImage: true,   birthPlace: "Dulangan, Pilar, Capiz, PH",       hasDNATest: false, },
