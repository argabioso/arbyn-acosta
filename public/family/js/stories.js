var STORIES = {
  'GQX8-CQP': { // Arbyn Argabioso
    ...
    stories: `
      ...
      <p>Y-DNA comes from the Y chromosome which is passed from father to son remaining mostly unaltered across generations. Given this, you can imagine "Y-DNA Haplogroup" as a line from me, to my father, to my paternal grandfather, to my paternal great grandfather, and so on.</p>
      <figure class="no-border">
        <img alt="My Haplogroup" src="images/stories/${isDark ? 'Arbyn_Argabioso_Haplogroup.dark.webp' : 'Arbyn_Argabioso_Haplogroup.light.webp'}" />
        <p class="caption"><em>My haplogroup timeline generated by FamilyTreeDNA.</em></p>
      </figure>
      ...
      <hr />
      <h5>My Family Line on Our Wedding</h5>
      <figure>
